        ...
        <div className='bg-slate-900 flex h-full'>
            ...
            <div className="max-w-[50rem] flex flex-col mx-auto w-full h-full">
                ...
                <div className="text-center py-10 px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="mt-3 text-lg text-gray-300">Isso não é um teste, você foi agraciada com o poder de escolhas de algumas coisas a mais em seu relacionamento...</p>
                ...
                <div className="container mx-auto px-4" data-controller="switch">
                    <div className="flex flex-row items-center justify-between">
                        ...
                        <p className="text-lg text-gray-300">Voce pode escolher: <span data-switch-target="counter">1</span> opções.</p>
                    </div>
                    
                    <div className="switchBox">
                        <div className="flex items-center mb-3 mt-3">
                            <input type="checkbox" data-action="click->switch#dispatch" id="switch" className="relative shrink-0 w-[3.25rem] h-7 bg-gray-100 checked:bg-none checked:bg-blue-600 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 border border-transparent ring-1 ring-transparent focus:border-blue-600 focus:ring-blue-600 ring-offset-white focus:outline-none appearance-none dark:bg-gray-700 dark:checked:bg-blue-600 dark:focus:ring-offset-gray-800
